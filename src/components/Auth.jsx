...
export const Auth = ({ setIsAuth }) => {
  ...
  return (
    <div className="auth min-h-screen max-h-fit flex justify-center flex-row items-center">
       <div className="left"> <h2 className="welcome mobseen flex justify-center items-center">Welcome To{" "}<span className="flick">Flick</span></h2>
      <h3 className="subtitle mobseen">&quot;Because spending time here is definitely more <br /> exciting than napping. Probably.&quot;</h3>
      <img  src={Chatters} alt="" /></div>
    
      <div className="container right flex flex-col"> <h2 className="welcome compseen flex ">Welcome To<span className="flick">Flick</span></h2>
